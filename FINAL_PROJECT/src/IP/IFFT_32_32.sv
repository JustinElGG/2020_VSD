...
logic signed [31:0] real_out_div , imag_out_div ;
assign real_out_div = {{6{FFT_1_real_out[31]}},FFT_1_real_out[30:21],FFT_1_real_out[20:5]} ;
assign imag_out_div = {{6{FFT_1_imag_out[31]}},FFT_1_imag_out[30:21],FFT_1_imag_out[20:5]} ;


logic store_finish,valid;
		...
		*/
		...
		if(enable) begin 
			if(counter > 11'd35 && counter < 11'd1059) begin
				...
				//register_real[counter2] <= real_out_div ;
				//register_imag[counter2] <= -imag_out_div ;	
			end
				...
				real_FFT_out <= real_out_div;
				imag_FFT_out <= -imag_out_div;
				valid <= 1'b1;
			end
...
begin
	if(counter > 11'd35 && counter < 11'd1059) begin
		A 		= counter2 ;
		real_DI = real_out_div ;
		imag_DI = -imag_out_div ;
		WEB 	= 1'b0; //write
		OE		= 1'b0;
